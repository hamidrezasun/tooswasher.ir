    ...
    <div css={sideNavbarStyles} className="open">
      <div className="p-4">
        ...
        <ul className="space-y-4">
          ...
          <li>
            <Link to="/admin/option" onClick={onClose} className="text-indigo-600 hover:underline">
              مدیریت تنظیمات
            </Link>
          </li>
          <li>
            <Link to="/admin/order" onClick={onClose} className="text-indigo-600 hover:underline">
              مدیریت سفارش‌ها
            </Link>
          </li>
        </ul>
